...
# Анализ двух ключевых событий приложения в Apache Superset.
...
Group by this_week,previous_week,status
```
### 2. Анализ маркетинговой компании проведенной 15.08.25
...
**2.1. Анализ метрики DAU**
ВЫВОД:
  - Сравнение показателя DAU за период с 12.08.25 по 19.09.25 с предыдущей неделей.
  - Разбивка по органическому и рекламному входу

**2.2.Пользователи привлеченные рекламной компанией**
ВЫВОД:



**2.3. Retention по когортам с 12.08.25 по 15.08.25 (Heatmap)**

![Аудиторные данные](https://github.com/Alexa-grab/desktop-tutorial/blob/main/%D1%80%D0%B5%D0%BA%D0%BB%D0%B0%D0%BC%D0%BD%D0%B0%D1%8F%20%D0%BA%D0%BE%D0%BC%D0%BF%D0%B0%D0%BD%D0%B8%D1%8F%203.png)
...
**2.4.Ретеншен 1го дня и последущая активность пользователей пришедших 15.08.25**
...
и пытались войти разными путями(по рекламной ссылке, например) 
